...
- `protocols/whole_genome_seq_wgs_flex.py` - scWGS prep coded end-to-end, but an
...
- [ ] Reconcile `whole_genome_seq_wgs_flex.py` with reality (deck, tips, volumes, pauses).
...
## 11. Proposed di-omics skill (separate artifact)
