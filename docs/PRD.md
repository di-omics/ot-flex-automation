...
- The library-prep chemistry (whole-genome sequencing preparation) is **expensive** per cell.
...
- **liquid handler + Agilent Bravo = the precision / production rigs.** Goal: port
...
### Phase 2 - Faithful whole-genome sequencing preparation actions, end-to-end on Flex
...
- [ ] Port the protocol to **liquid handler** and **Agilent Bravo**.
...
sparse samples** (whole-genome sequencing preparation/WGS preparation handling, dropout mitigation, low-input QC) and
