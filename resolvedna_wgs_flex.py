...
# ──────────────────────────────────────────────────────────────────────
# whole-genome sequencing on Opentrons Flex - BAREBONES STARTER
#
...
# building out the real whole-genome sequencing steps.
#
...
#
# To expand into the real run (whole-genome sequencing the kit user guide), we'll add:
...
metadata = {
    "protocolName": "whole-genome sequencing Flex - Barebones Starter",
    "author": "Di Hu",
