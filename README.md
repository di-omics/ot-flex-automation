...
**Section 3 - Bead Cleanup:** SPRI beads 0.75× -> 2× 80 % EtOH -> elute -> transfer
...
| File | Use |
|---|---|
| `protocols/whole_genome_seq_full_studio45_8ch_returntip_lower_source_demo.py` | Dry-run / water-demo version. Reuses one full 8-tip column and returns it at the end. |
| `protocols/whole_genome_seq_full_studio45_flex_v2_lower_source.py` | Fresh-tip liquid/wet-run version. Uses fresh tips and drops them. |
