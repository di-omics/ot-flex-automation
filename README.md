...
|------|--------------|--------|--------|
| `protocols/whole_genome_seq_wgs_flex.py` | the vendor whole-genome sequencing (the kit user guide) | Single-cell whole-genome libraries | **Run end-to-end** on the Flex |
...
```
protocols/
  whole_genome_seq_wgs_flex.py          WGS - run end-to-end on the Flex.
