...
metadata = {
    "protocolName": "whole-genome sequencing Full - Studio45 Flex 8ch Return-Tip Lower Source Demo",
    "author": "Di Hu / ChatGPT",
    "tipPolicy": "Water/demo mode: one 8-channel tip column is reused and returned; reservoir aspiration z=2.0",
    "description": (
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # DEMO TIP POLICY:
    # Use exactly one *8-channel tip column* for this WGS water/dry demo,
    # then return it at the end. This is NOT a 1-channel protocol: the instrument
    # is flex_8channel_1000 on the LEFT mount. Picking up A1 means one full 8-tip
    # column for the 8-channel head. Water/demo only; for real chemistry, revert
    # to fresh tips per reagent.
    demo_tip = tips_primary.wells()[0]

    def ensure_demo_tip():
        if not p8.has_tip:
            p8.pick_up_tip(demo_tip)
