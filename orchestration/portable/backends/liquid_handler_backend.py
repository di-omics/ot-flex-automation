"""liquid handler (Venus) backend - the seam, deliberately a stub.

A native Venus method is generated/edited in the liquid handler's tooling, not emitted as
...
def render_worklist(spec: ProtocolSpec) -> str:
    """Interim liquid handler path: the vendor-neutral worklist Venus can import now."""
